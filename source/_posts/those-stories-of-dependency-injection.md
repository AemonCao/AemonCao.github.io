...
2.  依赖注入那些事儿
    ...
    2.  多态的活性与依赖注入
        ...
        1.  不同活性多态性依赖注入的选择
3.  IoC Container
    0.  IoC Container出现的必然性
    1.  IoC Container的分类
        0.  重量级IoC Container
        1.  轻量级IoC Container
    2.  NET平台上典型IoC Container推介
        0.  Spring.NET
        1.  Unity
4.  参考文献
